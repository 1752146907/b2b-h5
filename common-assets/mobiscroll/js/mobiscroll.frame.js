            ...
            if (hasButtons) {
                ...
                $.each(buttons, function (i, b) {
                  ...
                  b.handler = isString(b.handler) ? that.handlers[b.handler] : b.handler;
                    ...
                    html += '<div class="dwbw ' + (b.parentClass || '') + '"><div tabindex="0" role="button" class="dwb' + i + ' dwb-e ' + (b.cssClass === undefined ? s.btnClass : b.cssClass) + (b.icon ? ' mbsc-ic mbsc-ic-' + b.icon : '') + '">' + (b.text || '') + '</div></div>';
                });
                html += '</div>';
            }
